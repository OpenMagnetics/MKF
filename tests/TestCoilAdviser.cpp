...
TEST_CASE("Test_CoilAdviser_Random_0", "[adviser][coil-adviser][bug]") {
    auto gapping = OpenMagneticsTesting::get_ground_gap(0.003);
    std::vector<double> turnsRatios;
    int64_t numberStacks = 1;
...
TEST_CASE("Test_CoilAdviser_Random_3", "[adviser][coil-adviser][bug]") {
...
TEST_CASE("Test_CoilAdviser_Random_4", "[adviser][coil-adviser][bug]") {
...
TEST_CASE("Test_CoilAdviser_Random_6", "[adviser][coil-adviser][bug]") {
...
TEST_CASE("Test_CoilAdviser_Random_13", "[adviser][coil-adviser][bug]") {
...
TEST_CASE("Test_CoilAdviser_Random_14", "[adviser][coil-adviser][bug]") {
...
TEST_CASE("Test_CoilAdviser_Random_15", "[adviser][coil-adviser][bug]") {
