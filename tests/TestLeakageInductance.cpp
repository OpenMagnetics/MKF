...
SUITE(LeakageInductance) {
    ...
    TEST(Test_Leakage_Inductance_Planar_2) {
        ...
        auto leakageInductanceOutput = OpenMagnetics::MagneticSimulator::calculate_leakage_inductance(magnetic, frequency);
        std::cout << leakageInductanceOutput.get_leakage_inductance_per_winding()[0].get_nominal().value() << std::endl;
