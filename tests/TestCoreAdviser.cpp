...
TEST_CASE("Test_CoreAdviser_Web_7", "[adviser][core-adviser][available-cores][bug]") {
    clear_databases();
    std::string file_path_1006 = std::source_location::current().file_name();
    auto json_path_1006 = file_path_1006.substr(0, file_path_1006.rfind("/")).append("/testData/test_coreadviser_web_7_1006.json");
...
TEST_CASE("Test_CoreAdviser_Web_8", "[adviser][core-adviser][available-cores][bug]") {
    clear_databases();
    std::string file_path_1070 = std::source_location::current().file_name();
    auto json_path_1070 = file_path_1070.substr(0, file_path_1070.rfind("/")).append("/testData/test_coreadviser_web_8_1070.json");
...
TEST_CASE("Test_CoreAdviser_Web_9", "[adviser][core-adviser][available-cores][bug]") {
    clear_databases();
    std::string file_path_1162 = std::source_location::current().file_name();
    auto json_path_1162 = file_path_1162.substr(0, file_path_1162.rfind("/")).append("/testData/test_coreadviser_web_9_1162.json");
