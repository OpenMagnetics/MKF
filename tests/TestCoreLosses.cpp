...
double run_test_core_losses(const CoreLossesModels& modelName,
    ...
    REQUIRE_THAT(calculatedVolumetricCoreLosses, Catch::Matchers::WithinAbs(expectedVolumetricLosses, expectedVolumetricLosses * maximumAdmittedErrorVolumetricCoreLossesValue));
...
TEST_CASE("Test_PQ_20_20_3F4", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    SKIP("Test needs investigation");
    test_core_losses_magnet_verification_3F4(CoreLossesModels::STEINMETZ);
}

TEST_CASE("Test_PQ_20_20_N49", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_verification_N49(CoreLossesModels::STEINMETZ);
}

TEST_CASE("Test_PQ_20_20_3C94", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_verification_3C94(CoreLossesModels::STEINMETZ);
}

TEST_CASE("Test_PQ_20_20_N27", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_verification_N27(CoreLossesModels::STEINMETZ);
}

TEST_CASE("Test_PQ_20_20_N87", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_verification_N87(CoreLossesModels::STEINMETZ);
}

TEST_CASE("Test_PQ_20_20_3C90", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_verification_3C90(CoreLossesModels::STEINMETZ);
}

TEST_CASE("Test_Magnet_3C90", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::STEINMETZ, "3C90");
}

TEST_CASE("Test_Magnet_3C94", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::STEINMETZ, "3C94");
}

TEST_CASE("Test_Magnet_3F4", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::STEINMETZ, "3F4");
}

TEST_CASE("Test_Magnet_N27", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::STEINMETZ, "N27");
}

TEST_CASE("Test_Magnet_N30", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::STEINMETZ, "N30");
}

TEST_CASE("Test_Magnet_N49", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::STEINMETZ, "N49");
}

TEST_CASE("Test_Magnet_N87", "[physical-model][core-losses][steinmetz-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::STEINMETZ, "N87");
}

TEST_CASE("Test_Ki_3C95", "[physical-model][core-losses][igse-core-losses-model]") {
    SKIP("Test needs investigation");
...
TEST_CASE("Test_PQ_20_20_3F4_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_verification_3F4(CoreLossesModels::IGSE);
}

TEST_CASE("Test_PQ_20_20_N49_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_verification_N49(CoreLossesModels::IGSE);
}

TEST_CASE("Test_PQ_20_20_3C94_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_verification_3C94(CoreLossesModels::IGSE);
}

TEST_CASE("Test_PQ_20_20_N27_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_verification_N27(CoreLossesModels::IGSE);
}

TEST_CASE("Test_PQ_20_20_N87_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_verification_N87(CoreLossesModels::IGSE);
}

TEST_CASE("Test_PQ_20_20_3C90_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_verification_3C90(CoreLossesModels::IGSE);
}

TEST_CASE("Test_Magnet_3C90_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::IGSE, "3C90");
}

TEST_CASE("Test_Magnet_3C94_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::IGSE, "3C94");
}

TEST_CASE("Test_Magnet_3F4_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::IGSE, "3F4");
}

TEST_CASE("Test_Magnet_N27_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::IGSE, "N27");
}

TEST_CASE("Test_Magnet_N30_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::IGSE, "N30");
}

TEST_CASE("Test_Magnet_N49_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::IGSE, "N49");
}

TEST_CASE("Test_Magnet_N87_2", "[physical-model][core-losses][igse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::IGSE, "N87");
}

TEST_CASE("Test_PQ_20_20_3F4_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_verification_3F4(CoreLossesModels::ALBACH);
}

TEST_CASE("Test_PQ_20_20_N49_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_verification_N49(CoreLossesModels::ALBACH);
}

TEST_CASE("Test_PQ_20_20_3C94_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_verification_3C94(CoreLossesModels::ALBACH);
}

TEST_CASE("Test_PQ_20_20_N27_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_verification_N27(CoreLossesModels::ALBACH);
}

TEST_CASE("Test_PQ_20_20_N87_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_verification_N87(CoreLossesModels::ALBACH);
}

TEST_CASE("Test_PQ_20_20_3C90_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_verification_3C90(CoreLossesModels::ALBACH);
}

TEST_CASE("Test_Magnet_3C90_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ALBACH, "3C90");
}

TEST_CASE("Test_Magnet_3C94_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ALBACH, "3C94");
}

TEST_CASE("Test_Magnet_3F4_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ALBACH, "3F4");
}

TEST_CASE("Test_Magnet_N27_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ALBACH, "N27");
}

TEST_CASE("Test_Magnet_N30_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ALBACH, "N30");
}

TEST_CASE("Test_Magnet_N49_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ALBACH, "N49");
}

TEST_CASE("Test_Magnet_N87_3", "[physical-model][core-losses][albach-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ALBACH, "N87");
}

TEST_CASE("Test_PQ_20_20_3F4_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_verification_3F4(CoreLossesModels::MSE);
}

TEST_CASE("Test_PQ_20_20_N49_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_verification_N49(CoreLossesModels::MSE);
}

TEST_CASE("Test_PQ_20_20_3C94_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_verification_3C94(CoreLossesModels::MSE);
}

TEST_CASE("Test_PQ_20_20_N27_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_verification_N27(CoreLossesModels::MSE);
}

TEST_CASE("Test_PQ_20_20_N87_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_verification_N87(CoreLossesModels::MSE);
}

TEST_CASE("Test_PQ_20_20_3C90_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_verification_3C90(CoreLossesModels::MSE);
}

TEST_CASE("Test_Magnet_3C90_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::MSE, "3C90");
}

TEST_CASE("Test_Magnet_3C94_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::MSE, "3C94");
}

TEST_CASE("Test_Magnet_3F4_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::MSE, "3F4");
}

TEST_CASE("Test_Magnet_N27_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::MSE, "N27");
}

TEST_CASE("Test_Magnet_N30_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::MSE, "N30");
}

TEST_CASE("Test_Magnet_N49_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::MSE, "N49");
}

TEST_CASE("Test_Magnet_N87_4", "[physical-model][core-losses][mse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::MSE, "N87");
}

TEST_CASE("Test_PQ_20_20_3F4_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_verification_3F4(CoreLossesModels::NSE);
}

TEST_CASE("Test_PQ_20_20_N49_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_verification_N49(CoreLossesModels::NSE);
}

TEST_CASE("Test_PQ_20_20_3C94_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_verification_3C94(CoreLossesModels::NSE);
}

TEST_CASE("Test_PQ_20_20_N27_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_verification_N27(CoreLossesModels::NSE);
}

TEST_CASE("Test_PQ_20_20_N87_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_verification_N87(CoreLossesModels::NSE);
}

TEST_CASE("Test_PQ_20_20_3C90_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_verification_3C90(CoreLossesModels::NSE);
}

TEST_CASE("Test_Magnet_3C90_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::NSE, "3C90");
}

TEST_CASE("Test_Magnet_3C94_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::NSE, "3C94");
}

TEST_CASE("Test_Magnet_3F4_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::NSE, "3F4");
}

TEST_CASE("Test_Magnet_N27_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::NSE, "N27");
}

TEST_CASE("Test_Magnet_N30_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::NSE, "N30");
}

TEST_CASE("Test_Magnet_N49_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::NSE, "N49");
}

TEST_CASE("Test_Magnet_N87_5", "[physical-model][core-losses][nse-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::NSE, "N87");
}

TEST_CASE("Test_PQ_20_20_3F4_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_verification_3F4(CoreLossesModels::BARG);
}

TEST_CASE("Test_PQ_20_20_N49_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_verification_N49(CoreLossesModels::BARG);
}

TEST_CASE("Test_PQ_20_20_3C94_6", "[physical-model][core-losses][barg-core-losses-model]") {
    SKIP("Test needs investigation");
    test_core_losses_magnet_verification_3C94(CoreLossesModels::BARG);
}

TEST_CASE("Test_PQ_20_20_N27_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_verification_N27(CoreLossesModels::BARG);
}

TEST_CASE("Test_PQ_20_20_N87_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_verification_N87(CoreLossesModels::BARG);
}

TEST_CASE("Test_PQ_20_20_3C90_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_verification_3C90(CoreLossesModels::BARG);
}

TEST_CASE("Test_Magnet_3C90_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::BARG, "3C90");
}

TEST_CASE("Test_Magnet_3C94_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::BARG, "3C94");
}

TEST_CASE("Test_Magnet_3F4_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::BARG, "3F4");
}

TEST_CASE("Test_Magnet_N27_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::BARG, "N27");
}

TEST_CASE("Test_Magnet_N30_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::BARG, "N30");
}

TEST_CASE("Test_Magnet_N49_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::BARG, "N49");
}

TEST_CASE("Test_Magnet_N87_6", "[physical-model][core-losses][barg-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::BARG, "N87");
}

TEST_CASE("Test_PQ_20_20_N49_7", "[physical-model][core-losses][roshen-core-losses-model]") {
    test_core_losses_magnet_verification_N49(CoreLossesModels::ROSHEN);
}

TEST_CASE("Test_PQ_20_20_3C94_7", "[physical-model][core-losses][roshen-core-losses-model]") {
    test_core_losses_magnet_verification_3C94(CoreLossesModels::ROSHEN);
}

TEST_CASE("Test_PQ_20_20_N27_7", "[physical-model][core-losses][roshen-core-losses-model]") {
    test_core_losses_magnet_verification_N27(CoreLossesModels::ROSHEN);
}

TEST_CASE("Test_PQ_20_20_N87_7", "[physical-model][core-losses][roshen-core-losses-model]") {
    test_core_losses_magnet_verification_N87(CoreLossesModels::ROSHEN);
}

TEST_CASE("Test_PQ_20_20_3C90_7", "[physical-model][core-losses][roshen-core-losses-model]") {
    test_core_losses_magnet_verification_3C90(CoreLossesModels::ROSHEN);
}

TEST_CASE("Test_Magnet_3C90_7", "[physical-model][core-losses][roshen-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ROSHEN, "3C90");
}

TEST_CASE("Test_Magnet_3C94_7", "[physical-model][core-losses][roshen-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ROSHEN, "3C94");
}

TEST_CASE("Test_Magnet_N27_7", "[physical-model][core-losses][roshen-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ROSHEN, "N27");
}

TEST_CASE("Test_Magnet_N49_7", "[physical-model][core-losses][roshen-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ROSHEN, "N49");
}

TEST_CASE("Test_Magnet_N87_7", "[physical-model][core-losses][roshen-core-losses-model]") {
    test_core_losses_magnet_data(CoreLossesModels::ROSHEN, "N87");
}

TEST_CASE("Voltage_And_Current", "[physical-model][core-losses]") {
...
TEST_CASE("Only_Current_0", "[physical-model][core-losses]") {
    auto models = json::parse("{\"coreLosses\": \"IGSE\", \"gapReluctance\": \"BALAKRISHNAN\"}");
    auto core = Core(json::parse(
        "{\"functionalDescription\": {\"gapping\": [{\"area\": 9.8e-05, \"coordinates\": [0.0, 0.0001, 0.0], "
        "\"distanceClosestNormalSurface\": 0.011301, \"distanceClosestParallelSurface\": 0.006999999999999999, "
...
TEST_CASE("Only_Current_1", "[physical-model][core-losses]") {
...
TEST_CASE("Only_Voltage", "[physical-model][core-losses]") {
    auto models =
...
TEST_CASE("Only_Current_With_Dc", "[physical-model][core-losses]") {
    auto models = json::parse("{\"coreLosses\": \"IGSE\", \"gapReluctance\": \"BALAKRISHNAN\"}");
    auto core = Core(json::parse(
        "{\"functionalDescription\": {\"gapping\": [{\"area\": 9.8e-05, \"coordinates\": [0.0, 0.0001, 0.0], "
        "\"distanceClosestNormalSurface\": 0.011301, \"distanceClosestParallelSurface\": 0.006999999999999999, "
...
TEST_CASE("Crash_Voltage_Sin", "[physical-model][core-losses][bug]") {
    ...
    REQUIRE_THAT(magneticFluxDensity.get_processed().value().get_offset(), Catch::Matchers::WithinAbs(0, 0.001));
}

TEST_CASE("Crash_Losses", "[physical-model][core-losses][bug]") {
...
TEST_CASE("Crash_Toroids", "[physical-model][core-losses][bug]") {
    auto models = json::parse(R"({"coreLosses": "IGSE", "coreTemperature": "MANIKTALA", "gapReluctance": "ZHANG"})");
...
TEST_CASE("Test_Methods", "[physical-model][core-losses]") {
    ...
    REQUIRE(methods.size() == 1);
    REQUIRE(methods[0] == "lossFactor");
}

TEST_CASE("Test_Manufacturer_Magnetics", "[physical-model][core-losses]") {
    auto models =
    ...
    REQUIRE_THAT(magneticFluxDensity.get_processed().value().get_offset(), Catch::Matchers::WithinAbs(0, 0.002));
    ...
    REQUIRE_THAT(coreLosses.get_core_losses(), Catch::Matchers::WithinAbs(31.2, 31.2 * maxError));
}

TEST_CASE("Test_Manufacturer_Micrometals", "[physical-model][core-losses]") {
    auto models =
        json::parse(R"({"coreLosses": "PROPRIETARY", "coreTemperature": "MANIKTALA", "gapReluctance": "ZHANG"})");
    auto core = Core(json::parse(
    ...
    REQUIRE_THAT(magneticFluxDensity.get_processed().value().get_offset(), Catch::Matchers::WithinAbs(0, 0.002));
    REQUIRE_THAT(coreLosses.get_core_losses(), Catch::Matchers::WithinAbs(23.1, 23.1 * maxError));
}

TEST_CASE("Test_Manufacturer_Magnetec", "[physical-model][core-losses]") {
    auto models =
        json::parse(R"({"coreLosses": "PROPRIETARY", "coreTemperature": "MANIKTALA", "gapReluctance": "ZHANG"})");
...
TEST_CASE("Test_XFlux_19", "[physical-model][core-losses]") {
...
TEST_CASE("Test_A07", "[physical-model][core-losses]") {
...
TEST_CASE("Test_Kool_Mu_Ultra_60", "[physical-model][core-losses]") {
    ...
    REQUIRE_THAT(0.232, Catch::Matchers::WithinAbs(magneticFluxDensity.get_processed().value().get_offset(), 0.232 * maximumError));
    REQUIRE_THAT(expectedLosses, Catch::Matchers::WithinAbs(calculatedCoreLosses, expectedLosses * maximumError));
}

TEST_CASE("Test_NPF_26", "[physical-model][core-losses]") {
    auto models = json::parse("{\"coreLosses\": \"PROPRIETARY\", \"gapReluctance\": \"BALAKRISHNAN\"}");
...
TEST_CASE("Test_Core_Losses_Rosano_Forward", "[physical-model][core-losses]") {
    std::string file_path = __FILE__;
...
TEST_CASE("Test_Core_Losses_Simple_Forward", "[physical-model][core-losses]") {
    ...
    REQUIRE(magneticFluxDensity.get_processed().value().get_peak().value() < 0.5);
    REQUIRE_THAT(expectedLosses, Catch::Matchers::WithinAbs(calculatedCoreLosses, expectedLosses * maximumError));
}
...
TEST_CASE("Test_Core_Losses_Simple_Inductor", "[physical-model][core-losses]") {
    std::string file_path = __FILE__;
...
TEST_CASE("Test_MagnetizingInductanceModel_From_Excitation", "[physical-model][core-losses]") {
    std::string file_path = __FILE__;
    auto path = file_path.substr(0, file_path.rfind("/")).append("/testData/no_losses_acme.json");
    // auto path = file_path.substr(0, file_path.rfind("/")).append("/testData/hoganas_no_50_Hz.json");
    auto mas = OpenMagneticsTesting::mas_loader(path);
...
TEST_CASE("Test_CoreLosses_Model_3C95", "[physical-model][core-losses]") {
    auto coreLossesModel = CoreLosses().get_core_losses_model("3C95");
}

TEST_CASE("Test_CoreLosses_Model_Nanoperm_8000", "[physical-model][core-losses]") {
    auto coreLossesModel = CoreLosses().get_core_losses_model("Nanoperm 8000");
}

TEST_CASE("Test_Core_Losses_Nanoperm_8000", "[physical-model][core-losses]") {
    auto models = json::parse("{\"coreLosses\": \"PROPRIETARY\", \"gapReluctance\": \"BALAKRISHNAN\"}");
...
TEST_CASE("Test_Core_Losses_Web_1", "[physical-model][core-losses][bug]") {
    std::string file_path = __FILE__;
...
TEST_CASE("Test_Core_Losses_DMEGC_DMR51W", "[physical-model][core-losses][bug]") {
    auto models = json::parse("{\"coreLosses\": \"STEINMETZ\", \"gapReluctance\": \"BALAKRISHNAN\"}");
...
TEST_CASE("Test_Core_Losses_DMEGC_DMR52W", "[physical-model][core-losses][bug]") {
    auto models = json::parse("{\"coreLosses\": \"STEINMETZ\", \"gapReluctance\": \"BALAKRISHNAN\"}");
...
TEST_CASE("Test_Core_Losses_DMEGC_DMR51", "[physical-model][core-losses][bug]") {
    auto models = json::parse("{\"coreLosses\": \"STEINMETZ\", \"gapReluctance\": \"BALAKRISHNAN\"}");
    SKIP("Test needs investigation");
...
TEST_CASE("Frequency_From_Losses_Steinmetz", "[physical-model][core-losses]") {
    auto models = json::parse("{\"coreLosses\": \"STEINMETZ\", \"gapReluctance\": \"BALAKRISHNAN\"}");
    auto core = Core(json::parse(
        "{\"functionalDescription\": {\"gapping\": [{\"area\": 9.8e-05, \"coordinates\": [0.0, 0.0001, 0.0], "
        "\"distanceClosestNormalSurface\": 0.011301, \"distanceClosestParallelSurface\": 0.006999999999999999, "
    ...
    REQUIRE_THAT(excitation.get_frequency(), Catch::Matchers::WithinAbs(frequencyFromCoreLosses, frequencyFromCoreLosses * maxError));
}

TEST_CASE("Frequency_From_Losses_Igse", "[physical-model][core-losses]") {
    auto models = json::parse("{\"coreLosses\": \"IGSE\", \"gapReluctance\": \"BALAKRISHNAN\"}");
    auto core = Core(json::parse(
        "{\"functionalDescription\": {\"gapping\": [{\"area\": 9.8e-05, \"coordinates\": [0.0, 0.0001, 0.0], "
        "\"distanceClosestNormalSurface\": 0.011301, \"distanceClosestParallelSurface\": 0.006999999999999999, "
...
TEST_CASE("Frequency_From_Losses_Magnetics", "[physical-model][core-losses]") {
    auto models = json::parse("{\"coreLosses\": \"PROPRIETARY\", \"gapReluctance\": \"BALAKRISHNAN\"}");
    auto core = Core(json::parse(
        "{\"functionalDescription\": {\"gapping\": [{\"area\": 9.8e-05, \"coordinates\": [0.0, 0.0001, 0.0], "
        "\"distanceClosestNormalSurface\": 0.011301, \"distanceClosestParallelSurface\": 0.006999999999999999, "
...
TEST_CASE("Frequency_From_Losses_Micrometals", "[physical-model][core-losses]") {
    auto models =
        json::parse(R"({"coreLosses": "PROPRIETARY", "coreTemperature": "MANIKTALA", "gapReluctance": "ZHANG"})");
    auto core = Core(json::parse(
        R"({"functionalDescription": {"gapping": [{"area": null, "coordinates": null, "distanceClosestNormalSurface": null, "distanceClosestParallelSurface": null, "length": 0.001, "sectionDimensions": null, "shape": null, "type": "subtractive"}, {"area": null, "coordinates": null, "distanceClosestNormalSurface": null, "distanceClosestParallelSurface": null, "length": 1e-05, "sectionDimensions": null, "shape": null, "type": "residual"}, {"area": null, "coordinates": null, "distanceClosestNormalSurface": null, "distanceClosestParallelSurface": null, "length": 1e-05, "sectionDimensions": null, "shape": null, "type": "residual"}], "material": "MS 40", "numberStacks": 1, "shape": {"aliases": [], "dimensions": {"A": 0.0391, "B": 0.0198, "C": 0.0125, "D": 0.0146, "E": 0.030100000000000002, "F": 0.0125, "G": 0.0, "H": 0.0}, "family": "etd", "familySubtype": "1", "magneticCircuit": null, "name": "ETD 39/20/13", "type": "standard"}, "type": "two-piece set"}, "manufacturerInfo": null, "name": "My Core"})"));
...
TEST_CASE("Frequency_From_Losses_Poco", "[physical-model][core-losses]") {
    auto models =
        json::parse(R"({"coreLosses": "PROPRIETARY", "coreTemperature": "MANIKTALA", "gapReluctance": "ZHANG"})");
    auto core = Core(json::parse(
...
TEST_CASE("Frequency_From_Losses_TDG", "[physical-model][core-losses]") {
    auto models =
        json::parse(R"({"coreLosses": "PROPRIETARY", "coreTemperature": "MANIKTALA", "gapReluctance": "ZHANG"})");
    auto core = Core(json::parse(
        R"({"functionalDescription": {"gapping": [{"area": null, "coordinates": null, "distanceClosestNormalSurface": null, "distanceClosestParallelSurface": null, "length": 0.001, "sectionDimensions": null, "shape": null, "type": "subtractive"}, {"area": null, "coordinates": null, "distanceClosestNormalSurface": null, "distanceClosestParallelSurface": null, "length": 1e-05, "sectionDimensions": null, "shape": null, "type": "residual"}, {"area": null, "coordinates": null, "distanceClosestNormalSurface": null, "distanceClosestParallelSurface": null, "length": 1e-05, "sectionDimensions": null, "shape": null, "type": "residual"}], "material": "TMH 90", "numberStacks": 1, "shape": {"aliases": [], "dimensions": {"A": 0.0391, "B": 0.0198, "C": 0.0125, "D": 0.0146, "E": 0.030100000000000002, "F": 0.0125, "G": 0.0, "H": 0.0}, "family": "etd", "familySubtype": "1", "magneticCircuit": null, "name": "ETD 39/20/13", "type": "standard"}, "type": "two-piece set"}, "manufacturerInfo": null, "name": "My Core"})"));
    auto winding = OpenMagnetics::Coil(json::parse(
        R"({"bobbin": "Dummy", "functionalDescription": [{"isolationSide": "primary", "name": "Primary", "numberParallels": 1, "numberTurns": 43, "wire": "Dummy"}], "layersDescription": null, "sectionsDescription": null, "turnsDescription": null})"));
    auto operatingPoint = OperatingPoint(json::parse(
        R"({"conditions": {"ambientRelativeHumidity": null, "ambientTemperature": 25.0, "cooling": null, "name": null}, "excitationsPerWinding": [{"frequency": 100000.0, "magneticFieldStrength": null, "magneticFluxDensity": null, "magnetizingCurrent": null, "name": "My Operating Point", "voltage": {"harmonics": null, "processed": null, "waveform": {"ancillaryLabel": null, "data": [688.5, 688.5, -229.49999999999995, -229.49999999999995, 688.5], "numberPeriods": null, "time": [0.0, 2.4999999999999998e-06, 2.4999999999999998e-06, 1e-05, 1e-05]}}}], "name": null})"));
...
TEST_CASE("MagneticFluxDensity_From_Losses_Steinmetz", "[physical-model][core-losses]") {
    auto models = json::parse("{\"coreLosses\": \"STEINMETZ\", \"gapReluctance\": \"BALAKRISHNAN\"}");
    auto core = Core(json::parse(
        "{\"functionalDescription\": {\"gapping\": [{\"area\": 9.8e-05, \"coordinates\": [0.0, 0.0001, 0.0], "
        "\"distanceClosestNormalSurface\": 0.011301, \"distanceClosestParallelSurface\": 0.006999999999999999, "
...
TEST_CASE("MagneticFluxDensity_From_Losses_Igse", "[physical-model][core-losses]") {
    auto models = json::parse("{\"coreLosses\": \"IGSE\", \"gapReluctance\": \"BALAKRISHNAN\"}");
    auto core = Core(json::parse(
        "{\"functionalDescription\": {\"gapping\": [{\"area\": 9.8e-05, \"coordinates\": [0.0, 0.0001, 0.0], "
        "\"distanceClosestNormalSurface\": 0.011301, \"distanceClosestParallelSurface\": 0.006999999999999999, "
...
TEST_CASE("MagneticFluxDensity_From_Losses_Magnetics", "[physical-model][core-losses]") {
    auto models = json::parse("{\"coreLosses\": \"PROPRIETARY\", \"gapReluctance\": \"BALAKRISHNAN\"}");
    auto core = Core(json::parse(
        "{\"functionalDescription\": {\"gapping\": [{\"area\": 9.8e-05, \"coordinates\": [0.0, 0.0001, 0.0], "
        "\"distanceClosestNormalSurface\": 0.011301, \"distanceClosestParallelSurface\": 0.006999999999999999, "
...
TEST_CASE("MagneticFluxDensity_From_Losses_Micrometals", "[physical-model][core-losses]") {
    auto models =
        json::parse(R"({"coreLosses": "PROPRIETARY", "coreTemperature": "MANIKTALA", "gapReluctance": "ZHANG"})");
    auto core = Core(json::parse(
        R"({"functionalDescription": {"gapping": [{"area": null, "coordinates": null, "distanceClosestNormalSurface": null, "distanceClosestParallelSurface": null, "length": 0.001, "sectionDimensions": null, "shape": null, "type": "subtractive"}, {"area": null, "coordinates": null, "distanceClosestNormalSurface": null, "distanceClosestParallelSurface": null, "length": 1e-05, "sectionDimensions": null, "shape": null, "type": "residual"}, {"area": null, "coordinates": null, "distanceClosestNormalSurface": null, "distanceClosestParallelSurface": null, "length": 1e-05, "sectionDimensions": null, "shape": null, "type": "residual"}], "material": "MS 40", "numberStacks": 1, "shape": {"aliases": [], "dimensions": {"A": 0.0391, "B": 0.0198, "C": 0.0125, "D": 0.0146, "E": 0.030100000000000002, "F": 0.0125, "G": 0.0, "H": 0.0}, "family": "etd", "familySubtype": "1", "magneticCircuit": null, "name": "ETD 39/20/13", "type": "standard"}, "type": "two-piece set"}, "manufacturerInfo": null, "name": "My Core"})"));
