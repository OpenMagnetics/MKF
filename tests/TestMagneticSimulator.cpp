...
namespace { 
    ...
    TEST_CASE("MagneticSimulator", "[processor][magnetic-simulator][smoke-test]") {
    ...
    TEST_CASE("MagneticSimulatorJsonLV", "[processor][magnetic-simulator][smoke-test]") {
    ...
    TEST_CASE("Test_IEEE_Article_Simulation_0", "[processor][magnetic-simulator]") {
    ...
    TEST_CASE("Test_IEEE_Article_Simulation_1", "[processor][magnetic-simulator]") {
    ...
    TEST_CASE("Test_IEEE_Article_Simulation_2", "[processor][magnetic-simulator]") {
    ...
    TEST_CASE("Test_IEEE_Article_Simulation_3", "[processor][magnetic-simulator]") {
    ...
    TEST_CASE("Test_Simulator_Web_0", "[processor][magnetic-simulator][bug][smoke-test]") {
    ...
    TEST_CASE("Test_Simulator_Web_1", "[processor][magnetic-simulator][bug][smoke-test]") {
    ...
    TEST_CASE("Test_Simulator_Web_2", "[processor][magnetic-simulator][bug][smoke-test]") {
    ...
    TEST_CASE("Test_Simulator_Web_4", "[processor][magnetic-simulator][bug][smoke-test]") {
