...
SUITE(InitialPermeability)
{
    TEST(Test_XFlux_60)
    {
        ...
        double initial_permeability_value_with_temperature = initial_permeability.get_initial_permeability(material_data,
                                                                                                           &temperature,
                                                                                                           nullptr,
                                                                                                           nullptr);
        ...
        double initial_permeability_value_with_magnetic_field_dc_bias = initial_permeability.get_initial_permeability(material_data,
                                                                                                                      nullptr,
                                                                                                                      &magnetic_field_dc_bias,
                                                                                                                      nullptr);
        expected = 60 * 0.9601;
        CHECK_CLOSE(initial_permeability_value_with_magnetic_field_dc_bias, expected, 0.01 * expected);

        double frequency = 1250000;
        double initial_permeability_value_with_frequency = initial_permeability.get_initial_permeability(material_data,
                                                                                                         nullptr,
                                                                                                         nullptr,
                                                                                                         &frequency);
        expected = 60 * 0.968;
    ...
    TEST(Test_N88)
    {
        ...
        temperature = 200;
        initial_permeability_value_with_temperature = initial_permeability.get_initial_permeability(material_data,
                                                                                                    &temperature,
                                                                                                    nullptr,
                                                                                                    nullptr);
