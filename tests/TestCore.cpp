...
SUITE(CoreFunctionalDescription) {
    ...
    TEST(Web_2) {
        ...
        auto coreJson = json::parse(
            ...
            "[0.0, 1.0, 0.0], \"distanceClosestNormalSurface\": 0.0041, \"length\": 0.001, \"sectionDimensions\": "
            ...
            "{\"area\": 8.8e-05, \"coordinates\": [0.0, -1.0, -0.005751], \"distanceClosestNormalSurface\": 0.004598, "
