...
SUITE(Inputs)
{
    TEST(Test_One_Operation_Point_One_Winding_Triangular)
    {
        ...
        CHECK_CLOSE(excitation.get_current().value().get_processed().value().get_peak_to_peak(), 10, max_error * 10);
    ...
    TEST(Test_One_Operation_Point_One_Winding_Equidistant_Square)
    {
        ...
        CHECK_CLOSE(excitation.get_voltage().value().get_processed().value().get_peak_to_peak(), 10, max_error * 10);
    ...
    TEST(Test_One_Operation_Point_One_Winding_Triangular_Processed)
    {
        ...
        CHECK_CLOSE(excitation.get_current().value().get_processed().value().get_peak_to_peak(), 20, max_error * 20);
    ...
    TEST(Test_One_Operation_Point_One_Winding_Sinusoidal_Processed)
    {
        ...
        CHECK_CLOSE(excitation.get_current().value().get_processed().value().get_peak_to_peak(), 12, max_error * 12);
    ...
    TEST(Test_One_Operation_Point_One_Winding_Square_With_Dead_Time_Processed)
    {
        ...
        CHECK_CLOSE(excitation.get_current().value().get_processed().value().get_peak_to_peak(), 13, max_error * 13);
        CHECK_CLOSE(excitation.get_current().value().get_processed().value().get_offset(), 0, max_error);
    ...
    TEST(Test_One_Operation_Point_Two_Generated_Windings_Turns_Ratios)
    {
        ...
        for (auto &turnsRatioValue: turnsRatioValues) {
            ...
            CHECK_CLOSE(excitation_primary.get_current().value().get_processed().value().get_peak_to_peak(), 10, max_error * 10);
            ...
            CHECK_CLOSE(excitation_primary.get_voltage().value().get_processed().value().get_peak_to_peak(), 1, max_error * 1);
            ...
            CHECK_CLOSE(excitation_secondary.get_current().value().get_processed().value().get_peak_to_peak(), 
                        excitation_primary.get_current().value().get_processed().value().get_peak_to_peak() * turnsRatioValue,
                        max_error * excitation_primary.get_current().value().get_processed().value().get_peak_to_peak() * turnsRatioValue);
            ...
            CHECK_CLOSE(excitation_secondary.get_voltage().value().get_processed().value().get_peak_to_peak(), 
                        excitation_primary.get_voltage().value().get_processed().value().get_peak_to_peak() / turnsRatioValue,
                        max_error * excitation_primary.get_voltage().value().get_processed().value().get_peak_to_peak() / turnsRatioValue);
    ...
    TEST(Test_One_Operation_Point_One_Winding_Equidistant_Sinusoidal_Magnetizing_Current)
    {
        ...
        CHECK_CLOSE(excitation.get_magnetizing_current().value().get_processed().value().get_peak_to_peak(), 0.158, max_error * 0.158);
    ...
    TEST(Test_One_Operation_Point_One_Winding_Equidistant_Triangular_Magnetizing_Current)
    {
        ...
        CHECK_CLOSE(excitation.get_magnetizing_current().value().get_processed().value().get_peak_to_peak(), 0.1875, max_error * 0.1875);
        CHECK_CLOSE(excitation.get_magnetizing_current().value().get_processed().value().get_offset(), 0, max_error);
    ...
    TEST(Test_Quick_Operation_Point_No_Dc)
    {
        ...
        CHECK_CLOSE(excitation.get_magnetizing_current().value().get_processed().value().get_peak_to_peak(), 1.875, max_error * 1.875);
        CHECK_CLOSE(excitation.get_magnetizing_current().value().get_processed().value().get_offset(), 0, max_error);
