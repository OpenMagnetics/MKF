...
TEST_CASE("Test_One_Operating_Point_One_Winding_Equidistant_Sinusoidal", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_One_Operating_Point_One_Winding_Equidistant_Rectangular", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_One_Operating_Point_One_Winding_Triangular_Processed", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_One_Operating_Point_One_Winding_Rectangular_Processed", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_One_Operating_Point_One_Winding_Sinusoidal_Processed", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_One_Operating_Point_One_Winding_Bipolar_Rectangular_Processed", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_One_Operating_Point_One_Winding_Bipolar_Triangular_Processed", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_One_Operating_Point_Two_Generated_Windings_Turns_Ratios", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_One_Operating_Point_Three_Generated_Windings_Turns_Ratios_Must_Throw_Exception", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_One_Operating_Point_One_Winding_Equidistant_Sinusoidal_Magnetizing_Current", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_One_Operating_Point_One_Winding_Equidistant_Triangular_Magnetizing_Current", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_Quick_Operating_Point_No_Dc", "[processor][inputs]") {
    double dcCurrent = 0;
...
TEST_CASE("Test_Quick_Operating_Point", "[processor][inputs]") {
    double dcCurrent = 10;
    double ambientTemperature = 42;
    double dutyCycle = 0.75;
    double peakToPeak = 10;
    ...
    REQUIRE_THAT(excitation.get_magnetizing_current().value().get_processed().value().get_ac_effective_frequency().value(), Catch::Matchers::WithinAbs(129000, max_error * 129000));
    REQUIRE_THAT(excitation.get_magnetizing_current().value().get_processed().value().get_peak_to_peak().value(), Catch::Matchers::WithinAbs(1.855, max_error * 1.855));
    REQUIRE_THAT(excitation.get_magnetizing_current().value().get_processed().value().get_offset(), Catch::Matchers::WithinAbs(10, 10 * max_error));
...
TEST_CASE("Test_Get_Duty_Cycle_Triangular", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_Get_Duty_Cycle_Rectangular", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_Get_Duty_Cycle_Custom", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_Magnetizing_Current_Sinusoidal_Processed", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_Magnetizing_Current_Sinusoidal_Dc_Bias_Processed", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_Waveform_Coefficient_Sinusoidal", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_Waveform_Coefficient_Rectangular", "[processor][inputs]") {
    json inputsJson;
...
TEST_CASE("Test_Json_Web", "[processor][inputs]") {
...
TEST_CASE("Test_Induced_Voltage", "[processor][inputs]") {
    double max_error = 0.1;
    double peakToPeak = 10;
...
TEST_CASE("Test_Induced_Voltage_Unipolar_Triangular", "[processor][inputs]") {
    double max_error = 0.1;
    double peakToPeak = 10;
    double dutyCycle = 0.25;
    double magnetizingInductance = 10e-6;
...
TEST_CASE("Test_Induced_Current", "[processor][inputs]") {
    double max_error = 0.1;
...
TEST_CASE("Test_Try_Guess_Duty_Cycle", "[processor][inputs]") {
    double max_error = 0.1;
    double peakToPeak = 53.3333;
    double dutyCycle = 0.25;
    double frequency = 100000;
...
TEST_CASE("Test_Try_Guess_Sinusoidal", "[processor][inputs]") {
    double max_error = 0.1;
    double peakToPeak = 53.3333;
...
TEST_CASE("Test_Try_Guess_Triangular", "[processor][inputs]") {
    double max_error = 0.1;
    double peakToPeak = 53.3333;
    double dutyCycle = 0.25;
    double offset = 0;
...
TEST_CASE("Test_Try_Guess_Unipolar_Triangular", "[processor][inputs]") {
    double max_error = 0.1;
    double peakToPeak = 53.3333;
    double dutyCycle = 0.25;
    double offset = 0;
...
TEST_CASE("Test_Try_Guess_Unipolar_Rectangular", "[processor][inputs]") {
    double max_error = 0.1;
    double peakToPeak = 53.3333;
    double dutyCycle = 0.25;
    double offset = 0;
...
TEST_CASE("Test_Try_Guess_Rectangular", "[processor][inputs]") {
    double max_error = 0.1;
    double peakToPeak = 53.3333;
    double dutyCycle = 0.25;
    double offset = 0;
...
TEST_CASE("Test_Try_Guess_Bipolar_Rectangular", "[processor][inputs]") {
...
TEST_CASE("Test_Try_Guess_Bipolar_Triangular", "[processor][inputs]") {
    double max_error = 0.2;
    double peakToPeak = 53.3333;
    double dutyCycle = 0.5;
    double offset = 0;
...
TEST_CASE("Test_Try_Guess_Flyback_Primary", "[processor][inputs]") {
    double max_error = 0.1;
...
TEST_CASE("Test_Try_Guess_Flyback_Secondary", "[processor][inputs]") {
    double max_error = 0.1;
    double peakToPeak = 50;
    double dutyCycle = 0.25;
    double offset = 10;
...
TEST_CASE("Test_Sample_And_Compress_Sinusoidal", "[processor][inputs]") {
    Waveform waveform;
...
TEST_CASE("Test_Sample_And_Compress_Rectangular", "[processor][inputs]") {
    Waveform waveform;
...
TEST_CASE("Test_Sample_And_Compress_Triangular", "[processor][inputs]") {
    Waveform waveform;
...
TEST_CASE("Test_Sample_And_Compress_Unipolar_Triangular", "[processor][inputs]") {
    Waveform waveform;
...
TEST_CASE("Test_Sample_And_Compress_Unipolar_Rectangular", "[processor][inputs]") {
    Waveform waveform;
...
TEST_CASE("Test_Sample_And_Compress_Bipolar_Rectangular", "[processor][inputs]") {
    Waveform waveform;
...
TEST_CASE("Test_Sample_And_Compress_Flyback_Primary", "[processor][inputs]") {
    Waveform waveform;
...
TEST_CASE("Test_Sample_And_Compress_Flyback_Secondary", "[processor][inputs]") {
    Waveform waveform;
...
TEST_CASE("Test_Induced_Voltage_And_Magnetizing_Current_Sinusoidal", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
...
TEST_CASE("Test_Induced_Voltage_And_Magnetizing_Current_Bipolar_Rectangular", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
    double magnetizingInductance = 100e-6;
...
TEST_CASE("Test_Derivative_And_Integral_Sinusoidal", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
    double peakToPeak = 50;
...
TEST_CASE("Test_Derivative_And_Integral_Rectangular", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
    double peakToPeak = 10;
...
TEST_CASE("Test_Derivative_And_Integral_Bipolar_Rectangular", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
    double peakToPeak = 50;
...
TEST_CASE("Test_Reflect_Rectangular", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
    double max_error = 0.02;
...
TEST_CASE("Test_Reflect_Unipolar_Rectangular_Ratio_1", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
    double max_error = 0.02;
...
TEST_CASE("Test_Reflect_Unipolar_Rectangular_Ratio_2", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
    double max_error = 0.02;
...
TEST_CASE("Test_Reflect_Unipolar_Triangular_Ratio_2", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
    double max_error = 0.02;
...
TEST_CASE("Test_Reflect_Flyback_Primary_Ratio_2", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
    double max_error = 0.02;
...
TEST_CASE("Test_Reflect_Flyback_Secondary_Ratio_2", "[processor][inputs]") {
    Waveform waveform;
    std::vector<double> data;
    std::vector<double> time;
    double max_error = 0.02;
...
TEST_CASE("Test_Reflect_Flyback_Primary_Web", "[processor][inputs]") {
    double turnRatio = 1;
...
TEST_CASE("Test_Flyback_Json", "[processor][inputs]") {
...
TEST_CASE("Test_Standardize_Waveform", "[processor][inputs]") {
