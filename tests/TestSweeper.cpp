...
namespace {
    ...
    TEST_CASE("Test_Sweeper_Winding_Resistance_Over_Frequency_Many_Turns", "[processor][sweeper]") {
    ...
    TEST_CASE("Test_Sweeper_Resistance_Over_Frequency_Many_Turns", "[processor][sweeper]") {
        std::vector<int64_t> numberTurns = {80, 8, 6};
        std::vector<int64_t> numberParallels = {1, 2, 6};
        std::vector<double> turnsRatios = {16, 13};
        std::string shapeName = "ER 28";
    ...
    TEST_CASE("Test_Sweeper_Winding_Losses_Over_Frequency_Many_Turns", "[processor][sweeper]") {
        double temperature = 20;
        std::vector<int64_t> numberTurns = {80, 8, 6};
        std::vector<int64_t> numberParallels = {1, 2, 6};
        std::vector<double> turnsRatios = {16, 13};
    ...
    TEST_CASE("Test_Sweeper_Resistance_Over_Frequency_Web_0", "[processor][sweeper]") {
    ...
    TEST_CASE("Test_Sweeper_Winding_Losses_Over_Frequency_Web_0", "[processor][sweeper]") {
        ...
        auto path = OpenMagneticsTesting::get_test_data_path(std::source_location::current(), "bug_winding_losses_sweep.json");
    ...
    TEST_CASE("Test_Sweeper_Winding_Losses_Over_Frequency_Web_1", "[processor][sweeper]") {

        auto json_path_955 = OpenMagneticsTesting::get_test_data_path(std::source_location::current(), "test_sweeper_winding_losses_over_frequency_web_1_955.json");
        std::ifstream json_file_955(json_path_955);
        OpenMagnetics::Magnetic magnetic = json::parse(json_file_955);
