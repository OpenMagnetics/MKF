...
namespace {
    ...
    TEST_CASE("Test_Sweeper_Winding_Losses_Over_Frequency_Web_1", "[processor][sweeper]") {
        ...
        std::string file_path_955 = std::source_location::current().file_name();
        auto json_path_955 = file_path_955.substr(0, file_path_955.rfind("/")).append("/testData/test_sweeper_winding_losses_over_frequency_web_1_955.json");
