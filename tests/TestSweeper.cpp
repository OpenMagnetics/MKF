...
SUITE(Sweeper) {
    ...
    TEST(Test_Sweeper_Winding_Resistance_Over_Frequency_Many_Turns) {
        ...
        auto impedanceSweep = OpenMagnetics::Sweeper().sweep_winding_resistance_over_frequency(magnetic, 0.1, 1000000, 100, 0);
    ...
    TEST(Test_Sweeper_Resistance_Over_Frequency_Many_Turns) {
        ...
        auto impedanceSweep = OpenMagnetics::Sweeper().sweep_resistance_over_frequency(magnetic, 10000, 10000000, 100);
    ...
    TEST(Test_Sweeper_Core_Losses_Over_Frequency_Many_Turns) {
        ...
        auto coreSweep = OpenMagnetics::Sweeper().sweep_core_losses_over_frequency(magnetic, inputs.get_operating_points()[0], 10000, 1200000, 20);
    ...
    TEST(Test_Sweeper_Winding_Losses_Over_Frequency_Many_Turns) {
        ...
        auto coreSweep = OpenMagnetics::Sweeper().sweep_winding_losses_over_frequency(magnetic, inputs.get_operating_points()[0], 10000, 1200000, 20);
    ...
    TEST(Test_Sweeper_Resistance_Over_Frequency_Web_0) {
        ...
        auto sweep = OpenMagnetics::Sweeper().sweep_winding_resistance_over_frequency(magnetic, 1000, 4e+06, 1000, 0, 25);
    ...
    TEST(Test_Sweeper_Winding_Losses_Over_Frequency_Web_0) {
        ...
        auto sweep = OpenMagnetics::Sweeper::sweep_winding_losses_over_frequency(magnetic, operatingPoint, 1000, 4e+06, 200, 25, "log");
