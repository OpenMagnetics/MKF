...
namespace {
    ...
    TEST_CASE("MagneticAdviserJsonHV", "[adviser][magnetic-adviser][smoke-test]") {
        SKIP("Adviser not finding magnetics with current constraints");
        clear_databases();
        settings.reset();
