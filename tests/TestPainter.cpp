...
namespace { 
    ...
    TEST_CASE("Test_Coil_Magnetic_Field_Painter_Web_0", "[support][painter][magnetic-field-painter][rectangular-winding-window][smoke-test]") {
        ...
        auto json_path = file_path.substr(0, file_path.rfind("/")).append("/testData/test_coil_magnetic_field_painter_web_0.json");
        std::ifstream json_file(json_path);
        OpenMagnetics::Magnetic magnetic(json::parse(json_file));
        std::string file_path_609 = std::source_location::current().file_name();
        auto json_path_609 = file_path_609.substr(0, file_path_609.rfind("/")).append("/testData/test_coil_magnetic_field_painter_web_0_609.json");
    ...
    TEST_CASE("Test_Coil_Painter_Web_1", "[support][painter][magnetic-painter][round-winding-window][smoke-test]") {
        ...
        std::string file_path_1429 = std::source_location::current().file_name();
        auto json_path_1429 = file_path_1429.substr(0, file_path_1429.rfind("/")).append("/testData/test_coil_painter_web_1_1429.json");
    ...
    TEST_CASE("Test_Coil_Painter_Web_2", "[support][painter][magnetic-painter][round-winding-window][smoke-test]") {
        ...
        std::string file_path_1446 = std::source_location::current().file_name();
        auto json_path_1446 = file_path_1446.substr(0, file_path_1446.rfind("/")).append("/testData/test_coil_painter_web_2_1446.json");
    ...
    TEST_CASE("Test_Coil_Painter_Web_3", "[support][painter][magnetic-painter][round-winding-window][smoke-test]") {
        ...
        std::string file_path_1473 = std::source_location::current().file_name();
        auto json_path_1473 = file_path_1473.substr(0, file_path_1473.rfind("/")).append("/testData/test_coil_painter_web_3_1473.json");
    ...
    TEST_CASE("Test_Coil_Painter_Web_4", "[support][painter][magnetic-painter][round-winding-window]") {
        ...
        std::string file_path_1493 = std::source_location::current().file_name();
        auto json_path_1493 = file_path_1493.substr(0, file_path_1493.rfind("/")).append("/testData/test_coil_painter_web_4_1493.json");
        std::ifstream json_file_1493(json_path_1493);
        OpenMagnetics::Magnetic magnetic(json::parse(json_file_1493));
        std::string file_path_1494 = std::source_location::current().file_name();
        auto json_path_1494 = file_path_1494.substr(0, file_path_1494.rfind("/")).append("/testData/test_coil_painter_web_4_1494.json");
    ...
    TEST_CASE("Test_Coil_Painter_Web_6", "[support][painter][magnetic-painter][round-winding-window]") {
        ...
        std::string file_path_1530 = std::source_location::current().file_name();
        auto json_path_1530 = file_path_1530.substr(0, file_path_1530.rfind("/")).append("/testData/test_coil_painter_web_6_1530.json");
    ...
    TEST_CASE("Test_Field_Painter_Web_0", "[support][painter][magnetic-field-painter][rectangular-winding-window]") {
        ...
        std::string file_path_3410 = std::source_location::current().file_name();
        auto json_path_3410 = file_path_3410.substr(0, file_path_3410.rfind("/")).append("/testData/test_field_painter_web_0_3410.json");
    ...
    TEST_CASE("Test_Field_Painter_Web_1", "[support][painter][magnetic-field-painter][rectangular-winding-window]") {
        ...
        std::string file_path_3429 = std::source_location::current().file_name();
        auto json_path_3429 = file_path_3429.substr(0, file_path_3429.rfind("/")).append("/testData/test_field_painter_web_1_3429.json");
    ...
    TEST_CASE("Test_Field_Painter_Web_3", "[support][painter][magnetic-field-painter][rectangular-winding-window]") {
        ...
        std::string file_path_3469 = std::source_location::current().file_name();
        auto json_path_3469 = file_path_3469.substr(0, file_path_3469.rfind("/")).append("/testData/test_field_painter_web_3_3469.json");
