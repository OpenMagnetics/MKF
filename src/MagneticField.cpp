...
namespace OpenMagnetics {
    ...
    ElectromagneticParameter MagneticField::get_magnetic_flux(ElectromagneticParameter magnetizingCurrent, double reluctance, double numberTurns, double frequency) {
    ...
    ElectromagneticParameter MagneticField::get_magnetic_flux_density(ElectromagneticParameter magneticFlux, double area, double frequency) {
        ...
        magneticFluxDensity.set_processed(InputsWrapper::get_processed_data(magneticFluxDensity, magneticFluxDensityWaveform, true));
    ...
    ElectromagneticParameter MagneticField::get_magnetic_field_strength(ElectromagneticParameter magneticFluxDensity, double initialPermeability, double frequency){
        ...
        magneticFieldStrength.set_processed(InputsWrapper::get_processed_data(magneticFieldStrength, magneticFieldStrengthWaveform, true));
