...
current_advanced_materials_path = "/home/alf/OpenMagnetics/MAS/data/core_materials.ndjson"
...
ndjson.dump(current_advanced_materials_raw, open(f"{pathlib.Path(__file__).parent.resolve()}/ferroxcube_updated_core_materials.ndjson", "w"), ensure_ascii=False)
