...
// NOTE: the un-instantiable CoreLossesGSEModel declaration (its get_core_volumetric_losses
// was never defined anywhere, and no factory created it) was removed in the July 2026
// health pass; recover from git history if a GSE model is ever implemented.
