...
class Sweeper {
    ...
    static Curve2D sweep_resistance_over_frequency(MagneticWrapper magnetic, double start, double stop, size_t numberElements, size_t windingIndex, double temperature = Defaults().ambientTemperature, std::string title = "Resistance over frequency");
