...
/**
 * @brief Structure holding topology-level waveforms for Active Clamp Forward converter validation
 */
struct ActiveClampForwardTopologyWaveforms {
    // Time base
...
public:
     ...
     */
    std::vector<ActiveClampForwardTopologyWaveforms> simulate_and_extract_topology_waveforms(
        const std::vector<double>& turnsRatios,
        double magnetizingInductance);
