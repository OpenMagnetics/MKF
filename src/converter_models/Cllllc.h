...
// ─────────────────────────────────────────────────────────────
// AdvancedCllllc: bypass design step; user supplies all components.
// ─────────────────────────────────────────────────────────────
...
public:
    AdvancedCllllc() = default;
    ~AdvancedCllllc() = default;
    AdvancedCllllc(const json& j);
...
// ─────────────────────────────────────────────────────────────
// JSON serialization for AdvancedCllllc
// ─────────────────────────────────────────────────────────────
void from_json(const json& j, AdvancedCllllc& x);
void to_json(json& j, const AdvancedCllllc& x);

inline void from_json(const json& j, AdvancedCllllc& x) {
    // CllllcResonant base fields
    ...
    x.set_control_strategy(get_stack_optional<CllllcControlStrategy>(j, "controlStrategy"));
    ...
    x.set_operating_points(j.at("operatingPoints").get<std::vector<CllllcOperatingPoint>>());
...
inline void to_json(json& j, const AdvancedCllllc& x) {
    j = json::object();
