...
//
// Implementations marked with "TODO(clllc-v1)" throw std::logic_error so any
...
// =====================================================================
// process_operating_points — TODO(clllc-v1): full 5-state Nielsen
...
std::vector<OperatingPoint> Clllc::process_operating_points(
    ...
    throw std::logic_error(
        "Clllc::process_operating_points not yet implemented. "
...
OperatingPoint Clllc::process_operating_point_for_input_voltage(
        ...
        double /*magnetizingInductance*/) {
    throw std::logic_error(
        "Clllc::process_operating_point_for_input_voltage not yet implemented. "
