...
namespace OpenMagnetics {
    ...
    enum class CoreTemperatureModels : int { KAZIMIERCZUK, MANIKTALA, TDK, DIXON, AMIDON };
    ...
    class CoreTemperatureModel {
        ...
        public:
            ...
            virtual std::map<std::string, double> get_core_temperature(CoreWrapper core, double coreLosses, double ambientTemperature) = 0;
            ...
            static std::map<std::string, std::string> get_models_information() {
                ...
                information["Maniktala"] = R"(Based on "High-Frequency Magnetic Components 2nd Edition" by Marian Kazimierczuk)";
            ...
            static std::map<std::string, std::string> get_models_external_links() {
                ...
                external_links["Kazimierczuk"] = "https://www.goodreads.com/book/show/18861402-high-frequency-magnetic-components";
                external_links["Maniktala"] = "https://www.goodreads.com/book/show/12042906-switching-power-supplies-a-z";
                external_links["TDK"] = "https://www.tdk-electronics.tdk.com/download/531536/badc7640e8213233c951b4540e3745e2/pdf-applicationnotes.pdf";
    ...
    class CoreTemperatureManiktalaModel: public CoreTemperatureModel {
        public:
            std::map<std::string, double> get_core_temperature(CoreWrapper core, double coreLosses, double ambientTemperature);
    };
